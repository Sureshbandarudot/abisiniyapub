...
//@override
  ...
  Future<dynamic> VehiclegetData() async {
    // String url = 'https://staging.abisiniya.com/api/v1/booking/apartment/mybookings';
    String url = baseDioSingleton.AbisiniyaBaseurl + 'booking/vehicle/mybookings';
    SharedPreferences prefs = await SharedPreferences.getInstance();

    RetrivedBearertoekn = prefs.getString('tokenkey') ?? "";
    print('vehcile my booking booking token...');
    print(RetrivedBearertoekn);
                                                              ...
                                                              builder: (context, constraint) {
                                                                return SingleChildScrollView(
                                                                  ...
                                                                  child: Column(
                                                                    children: <Widget>[
                                                                      //Text('Your Apartments'),
                                                                      Text('Vehicles',style: TextStyle(fontSize: 22,fontWeight: FontWeight.w600,color: Colors.red),),
